...
draft: false
image: wordcloud.png
title: "[Profiling 01] Valgrind·Callgrind: 캐시 시뮬레이션과 호출 그래프"
...
**선행 챕터**: [샘플링 프로파일링: perf·VTune 원리](/post/profiling-analysis/sampling-profiling-perf-vtune/)를 먼저 읽으면 "샘플링 vs 시뮬레이션"의 대비가 선명해집니다. 캐시 계층(L1/L2/LL)과 캐시 미스가 왜 비싼지에 대한 기본 감각은 [Tr.02의 STL 컨테이너 비용](/post/cpp-optimization/stl-container-cost/) 수준이면 충분합니다.
