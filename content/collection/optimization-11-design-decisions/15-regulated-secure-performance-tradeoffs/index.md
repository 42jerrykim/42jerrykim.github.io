...
draft: false
image: wordcloud.png
title: "[Design 11] 규제·보안 제약 하 성능 (전문)"
slug: regulated-secure-performance-tradeoffs-expert
description: "규정 준수·보안 통제·감사 요구와 성능 예산이 충돌할 때의 트레이드오프와 완화책을 전문 난이도로 정리합니다. Tr.06·Tr.10 운영 제약과 연계해 의사결정 기록·SLO 협상 프레임을 제시합니다."
tags:
  - C++
  - Performance(성능)
  - Optimization(최적화)
...
|------|------|----------------|-----------|------|---------|
| 예: mTLS everywhere | 기밀성 | 지연 +x µs | Tr.01 벤치 | 세션 재개 | 플랫폼 |
...
- **Tr.06**: cgroup·seccomp·컨테이너 정책이 **syscall 경로**를 바꿉니다.  
- **Tr.10**: TLS 버전·인증서 검증·L7 방화벽이 **패킷 경로**를 바꿉니다.
...
규제·보안은 성능 최적화의 “적”이 아니라 **제약 조건**입니다. 제약을 숫자로 옮기면 Tr.01 측정과 Tr.12 회귀 방지에 자연스럽게 연결됩니다.
