...
**이전 장**: [POSIX AIO vs io_uring](/post/io-optimization/posix-aio-vs-io-uring-performance-comparison/) (챕터 12)
...
→ [File Locking 성능](/post/io-optimization/file-locking-performance-impact-alternatives/) (챕터 14)
