...
draft: false
image: wordcloud.png
title: "[Compiler 03] GCC vs Clang vs MSVC 최적화 차이"
...
<strong>GCC(GNU Compiler Collection)</strong>는 1987년 Richard Stallman이 자유 소프트웨어 운동의 일환으로 시작했습니다. GNU 생태계의 기본 컴파일러로, 수십 년에 걸쳐 수많은 아키텍처와 플랫폼을 지원하면서 넓은 호환성이 핵심 설계 목표였습니다. 루프 최적화·벡터화·인라이닝 전략은 실용적이고 안정적인 쪽을 지향하며, 특정 서버 워크로드에서 강점을 보이는 경우가 많습니다.
...
<strong>MSVC(Microsoft Visual C++)</strong>는 1993년부터 Windows 개발 도구로 발전했습니다. Visual Studio와의 긴밀한 통합, Windows ABI·COM·DLL 모델과의 호환이 최우선입니다. 2015년 이후 C++ 표준 준수가 크게 향상되었고, 최신 버전은 성능 최적화도 적극적으로 개선되고 있습니다.
...
**인라이닝 실패** 원인(가시성, ODR/ABI, 코드 크기), 인라이닝 리포트 확인 방법, Tr.02 연계를 다룹니다.
