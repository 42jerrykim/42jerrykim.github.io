...
**커리큘럼**(난이도 포함)·학습 목표·측정 기준·평가 체크리스트·선행·병행 트랙은 <strong>[00. Introduction: Low-latency 컴파일러·빌드 최적화](/post/compiler-optimization/getting-started-compiler-build-performance-tuning/)</strong>에서 모두 다룹니다. 01(최적화 플래그)부터 순서대로 읽거나, 해당 챕터만 골라 읽어도 됩니다.
