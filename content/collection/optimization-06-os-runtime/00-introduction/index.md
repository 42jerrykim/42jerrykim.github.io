...
**Phase C — 커널 바이패스·고급 주제 (챕터 07~09, 11~13, 15~18)** 챕터 07~09는 **개요(본 트랙)**이며, io_uring·XDP/eBPF·DPDK의 **심화 실전**은 Tr.09·Tr.10에서 이어집니다. 챕터 17~18은 클라우드 및 eBPF 환경의 특수 운영 주제를 다룹니다.
