...
마틴은 DIP 위반을 모두 없앨 수는 없지만 위반하는 클래스의 수는 줄일 수 있다고 말한다. 구체적인 것에 의존하는 코드를 Main 같은 적은 수의 컴포넌트에 집중시키는 것이 현실적인 목표다(Martin, 『Clean Architecture』, 2017).
...
- Robert C. Martin, 『Clean Architecture』, 2017 — DIP의 코딩 실천법과 아키텍처 수준 적용의 원 출처.
