...
마틴은 이런 문제를 <strong>횡단 관심사(cross-cutting concern)</strong>라고 부른다. "고양이 운송"이라는 요구사항은 어느 한 서비스에도 깔끔하게 속하지 않고, 택시 검색·선택·배차라는 기존 서비스 경계를 가로질러 흩어진다. 서비스 경계를 아무리 잘 나눠도, 그 경계와 어긋나는 요구사항이 등장하면 여러 서비스를 동시에 고쳐야 하는 상황은 피할 수 없다(Martin, 『Clean Architecture』, 2017, 27장).
