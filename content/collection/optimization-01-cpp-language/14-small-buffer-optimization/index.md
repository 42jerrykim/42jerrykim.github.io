...
**완전한 초보자?** 이 장은 [03장: 문자열 최적화](/post/cpp-optimization/string-optimization/)의 SSO와 [13장: 람다 표현식 성능](/post/cpp-optimization/lambda-performance/)의 클로저 크기 개념을 전제로 합니다. "작은 객체는 내부에 두고 큰 객체만 힙에 둔다"는 한 줄만 떠올릴 수 있으면 충분합니다.
