...
(1) 도입·정의·예시·비교·마무리가 있는가? (2) 학습 성과 목표·판단 기준·비판적 시각이 있는가? (3) 벤치마크 해석·FAQ·체크리스트·진단 도구가 있는가? (4) 용어 정리·이 장에서 다룬 내용·다음 장 링크가 있는가? (5) 본문이 500줄 이상인가? 위를 확인한 뒤 챕터 04(객체 수명 최적화)로 진행합니다.
...
→ [객체 수명 최적화](/collection/optimization-01-cpp-language/04-object-lifetime/) (챕터 04)
...
- **다음**: [객체 수명 최적화](/collection/optimization-01-cpp-language/04-object-lifetime/) (챕터 04)
