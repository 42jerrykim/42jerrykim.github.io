...
lastmod: 2026-03-24
draft: true
title: "[C++ Lang 17] ABI·링크 경계와 극한 성능 (전문)"
slug: abi-link-boundaries-extreme-cpp-performance
description: "전문 난이도 장으로, ODR·ABI·가시성·심볼 경계가 성능·인라이닝·LTO에 미치는 영향과 한계를 정리합니다. Tr.02 컴파일러·Tr.08 극한 기법과 연계해, 링크 타임까지 고려한 튜닝 판단 기준을 제시합니다."
tags:
  - C++
  - Performance
  - Optimization
...
→ [인라이닝 유도 기법](/collection/optimization-01-cpp-language/10-inlining-techniques/)  
→ [Tr.02 Introduction](/collection/optimization-02-compiler/00-introduction/)
