...
`collection_order` 기준으로 **이전 장**은 [Parameter Passing 전략](/post/cpp-optimization/parameter-passing/) (챕터 17)입니다. 인라이닝·TU 경계를 바로 복습하려면 [인라이닝 유도 기법](/post/cpp-optimization/inlining-techniques/) (챕터 12)을 함께 열어 두면 좋고, 숫자·리포트의 출처는 [Tr.02 컴파일러·빌드 최적화](/post/compiler-optimization/getting-started-compiler-build-performance-tuning/)에서 확인합니다.
