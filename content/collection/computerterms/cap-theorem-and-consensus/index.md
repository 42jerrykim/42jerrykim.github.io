...
합의 알고리즘의 리더 선출은 [CPU 스케줄링](/post/computerterms/cpu-scheduling/)의 우선순위 개념과 무관하게, 노드 간 투표로 이뤄진다는 점에서 완전히 다른 메커니즘이다. 분산시스템 갈래는 이 챕터로 마무리되며, 다음은 보안 갈래에 웹 취약점 챕터를 추가해 이어간다.
