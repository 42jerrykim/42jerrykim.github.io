...
스레드가 메모리를 공유하기 때문에 생기는 문제([레이스 컨디션과 락](/post/computerterms/race-conditions-and-locks/))는 동시성 갈래에서 자세히 다룬다. 여러 프로세스/스레드 중 어떤 것을 먼저 실행할지 결정하는 문제는 다음 챕터인 [CPU 스케줄링](/post/computerterms/cpu-scheduling/)에서 다룬다.
