...
description: "클로저는 함수가 자신이 정의된 렉시컬 환경의 변수를 기억해 반환 후에도 접근하는 원리입니다. 렉시컬 스코프와 동적 스코프의 차이를 JavaScript 카운터 예시로 다룹니다."
tags:
- Technology(기술)
- Education(교육)
...
> Abelson, H., & Sussman, G. J. (1996). *Structure and Interpretation of Computer Programs* (2nd ed.), Section 1.1.8: The Substitution Model. MIT Press.
