...
**인라이닝 유도 기법**을 다룹니다. inline·__forceinline 활용과 인라이닝을 유도하는 코드 패턴, 실패 원인 진단(Tr.03 컴파일러 트랙 연계)을 정리합니다. → [인라이닝 유도 기법](/post/cpp-optimization/inlining-techniques/) (챕터 12)
