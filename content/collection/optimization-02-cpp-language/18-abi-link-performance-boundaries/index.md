...
본 장은 **전문** 난이도입니다. **ABI(Application Binary Interface)**와 **링크 경계**는 “코드를 조금 바꿨는데 왜 최적화가 사라졌는가”를 설명할 때 자주 등장합니다. 인라이닝·LTO·PGO·멀티버저닝은 Tr.03에서 다루고, 여기서는 **언어·링크 모델이 만들어내는 벽**이 성능에 어떤 의미를 갖는지 정리합니다.
