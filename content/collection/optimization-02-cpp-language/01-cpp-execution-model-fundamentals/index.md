...
**시나리오 C — 핫패스 힙 할당**: 로그 문자열을 매 요청마다 조합해 힙에 올린다. CPU 연산은 가벼워 보여도 할당자와 OS 페이지 상태에 따라 꼬리 지연이 커질 수 있다. Tr.04·챕터 05(문자열)과 연결해 **“할당 횟수”**를 지표로 잡고, 미리 확보한 버퍼로 줄일 수 있는지 본다.
