...
- **Tr.06**: `io_uring`, cgroup I/O 제한, 커널 파라미터가 **같은 그림**에 있습니다.  
- **Tr.11**: 변경 승인·감사·보안 리뷰가 필요합니다.

## 마무리

스토리지 스택 커스터마이징은 **성능 엔지니어링**이자 **운영 계약 변경**입니다. 숫자는 Tr.01에서, 책임은 Tr.11에서 닫는다는 전제를 두고 접근하십시오.
