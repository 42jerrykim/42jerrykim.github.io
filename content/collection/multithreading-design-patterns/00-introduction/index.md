...
| 11 | 공유 회피 | Immutable, Copy-on-Write, Thread-Specific Storage(`thread_local`) | 심화 | JCiP, POSA2 |
| 12 | 코루틴 기반 비동기 재해석 | `co_await`으로 다시 쓰는 Future/Promise·Active Object, 코루틴 프레임의 비용 | 심화 | cppreference, Kostruba 2024 |
| 13 | Lock-Free 심화: 회수 전략 | Hazard Pointer(P2530), RCU(P2545) — C++26 표준 라이브러리 사용법 | 심화 | P2530, P2545, Grimm 2025 |
