...
**Phase B — 프로파일링 (챕터 03~05, 13~15)** 샘플링·트레이싱·플레임 그래프로 “어디가 느린지”를 본 뒤, 플랫폼별 도구(VTune, perf, ETW)로 내려갑니다.

**Phase C — 하드웨어·운영 (챕터 06~12, 16~17)** 하드웨어 카운터, 꼬리 지연, 지속적 프로파일링, BPF, 분산 트레이싱은 **심화~전문**에 가깝습니다. Tr.06·Tr.07과 같이 읽으면 이벤트 의미가 정리됩니다.
