...
description: "이 문서는 리눅스 및 유닉스 환경에서 파일 및 디렉터리 목록을 출력하는 ls 명령어의 다양한 사용법, 주요 옵션, 상세 기능, 실전 예시와 출력 포맷까지 초보자와 숙련 개발자가 효율적으로 활용할 수 있도록 150자 분량으로 쉽게 설명합니다."
title: "[Bash Shell] ls - 파일 목록 출력"
date: 2022-01-01
categories:
- Bash Shell
tags:
