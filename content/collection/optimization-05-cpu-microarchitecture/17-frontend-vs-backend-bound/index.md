...
draft: false
image: wordcloud.png
title: "[CPU 05] Frontend vs Backend Bound 개념"
...
| Retiring이 높은데 p99가 나쁨 | 카운터가 못 보는 OS·스케줄링 요인 | Tr.01 프로파일링, Tr.06 OS 트랙 |
