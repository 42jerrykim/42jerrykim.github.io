...
오늘은 영어 명사 <strong>'representation'</strong>의 의미와 실제 쓰임을 정리한다.  
...
### 의미3: 대리, 대변(특히 법률 대리: legal representation)
...
**representation**은 라틴어 *repraesentare*(다시, 눈앞에 ‘나타내다/현재화하다’)에서 유래했다.  
...
| 단어 | 핵심 의미 | 차이점 |
|------|----------|--------|
| **depiction** | 묘사, 그려냄 | 시각적/서술적 ‘그려냄’에 초점(표현의 결과물 느낌이 강함) |
| **portrayal** | 인물/상황 묘사 | 작품/미디어에서 인물·사건을 ‘어떻게 그렸는지’의 뉘앙스 |
| **illustration** | 삽화, 예시 | 그림 자체 또는 설명을 돕는 예시(설명 기능 강조) |
| **image** | 이미지, 그림 | 가장 일반적인 결과물; representation보다 맥락/역할 정보는 약함 |
| **symbol** | 상징 | “대신 나타내는 표지”에 초점(추상적/관습적) |
| **advocacy** | 옹호, 대변 | 대리의 ‘행동’(권익 옹호) 쪽에 초점; representation은 범위가 더 넓음 |
| **claim / statement** | 주장/진술 | 일반어; representation은 법률/계약 맥락에서 더 자주 등장 |
...
- **주의**:
  ...
  - 계약/법률 문맥에서는 ‘그럴듯한 말’이 아니라 **사실관계에 대한 진술**이라는 뜻으로 자주 쓰인다.
...
11. The model provides a simplified representation of the system.  
   (그 모델은 시스템을 단순화해 나타낸 것이다.)
12. We changed the representation of dates to avoid ambiguity.  
   (우리는 모호함을 피하려고 날짜 표현 방식을 바꿨다.)
13. The diagram is a graphical representation of the workflow.  
   (그 도표는 워크플로를 그래픽으로 나타낸 것이다.)
14. Choose a representation that makes comparisons easy.  
   (비교가 쉽게 되는 표현 방식을 선택하라.)
15. The new UI offers a clearer representation of status.  
   (새 UI는 상태를 더 명확하게 보여 준다.)
16. The report includes a visual representation of risk levels.  
   (보고서에는 위험 수준을 시각적으로 나타낸 내용이 포함돼 있다.)
17. A table is a compact representation of many values.  
   (표는 많은 값을 압축해서 보여 주는 방식이다.)
18. The data representation must be consistent across services.  
   (데이터 표현 방식은 서비스 전반에서 일관돼야 한다.)
19. This encoding is a common representation for text.  
   (이 인코딩은 텍스트의 흔한 표현 방식이다.)
20. The graph is a symbolic representation of relationships.  
   (그 그래프는 관계를 상징적으로 나타낸 것이다.)

### 3) 대표성: 조직·정치에서의 참여/반영(의미2)
21. The council wants better representation of young people.  
   (그 의회는 청년층의 더 나은 대표성을 원한다.)
22. The team lacks representation from the customer support side.  
   (그 팀은 고객지원 쪽의 대표가 부족하다.)
23. Equal representation is important for fair decisions.  
   (공정한 결정을 위해서는 동등한 대표성이 중요하다.)
24. The company promised more representation in leadership roles.  
   (그 회사는 리더십 직책에서 더 많은 대표성을 약속했다.)
25. Political representation should reflect the population.  
   (정치적 대표성은 인구 구성을 반영해야 한다.)
26. She advocates for representation of minorities in media.  
   (그녀는 미디어에서 소수자 재현/대표성을 옹호한다.)
27. Underrepresentation can lead to blind spots in policy.  
   (대표성이 부족하면 정책에 사각지대가 생길 수 있다.)
28. The board increased representation from regional offices.  
   (이사회는 지역 지사의 대표 참여를 늘렸다.)
29. The union demanded representation in the negotiations.  
   (노조는 협상에서 대표 참여를 요구했다.)
30. The panel ensured representation from multiple disciplines.  
   (그 패널은 여러 분야의 대표 참여를 보장했다.)

### 4) 대리/대변: 누군가를 대신해 행동/발언(의미3)
31. He asked for representation before signing anything.  
   (그는 어떤 서류도 서명하기 전에 대리(법률 조력)를 요청했다.)
32. The defendant received legal representation at no cost.  
   (피고는 비용 없이 법률 대리를 받았다.)
33. She refused to speak without representation by counsel.  
   (그녀는 변호인 조력 없이 말하길 거부했다.)
34. The artist secured representation through a gallery.  
   (그 예술가는 갤러리를 통해 대리(에이전시)를 확보했다.)
35. Our distributor provides local representation in Asia.  
   (우리 유통사는 아시아에서 현지 대리(대행)를 제공한다.)
36. He serves as the company’s representative for public representation.  
   (그는 대외 대변을 위한 회사 대표 역할을 한다.)
37. The association offers representation for freelancers.  
   (그 협회는 프리랜서를 위한 대변(대표) 역할을 제공한다.)
38. They hired a firm for representation during the dispute.  
   (그들은 분쟁 동안 대리를 맡길 회사를 고용했다.)
39. Good representation can change the outcome of a case.  
   (좋은 법률 대리는 사건 결과를 바꿀 수 있다.)
40. He complained about inadequate representation.  
   (그는 부실한 대리(변호)에 대해 불만을 제기했다.)

### 5) 진술/주장: 계약/법률에서의 사실관계 진술(의미4)
41. The seller’s representation turned out to be false.  
   (판매자의 진술은 결국 거짓으로 드러났다.)
42. The buyer relied on the representation about safety.  
   (구매자는 안전에 관한 그 진술을 신뢰했다.)
43. A false representation can be considered fraud.  
   (허위 진술은 사기로 간주될 수 있다.)
44. The contract lists the representations and warranties in detail.  
   (그 계약서는 진술 및 보증을 자세히 나열한다.)
45. The company denied making any misleading representations.  
   (그 회사는 오해를 유발하는 진술을 한 적이 없다고 부인했다.)
46. The court examined whether the representation was material.  
   (법원은 그 진술이 중요한 사항인지 검토했다.)
47. Any representation made in writing must be accurate.  
   (서면으로 한 모든 진술은 정확해야 한다.)
48. He was sued for misrepresentation in the deal.  
   (그는 거래에서의 허위 진술(왜곡)로 소송을 당했다.)
49. The policy prohibits false representations to customers.  
   (그 정책은 고객에게 허위 진술을 하는 것을 금지한다.)
50. She clarified her representation to avoid misunderstanding.  
