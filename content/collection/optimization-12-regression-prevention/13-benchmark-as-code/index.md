...
이 장은 [Tr.12 02장: 벤치마크 CI 통합](/post/regression-prevention/benchmark-ci-integration-codspeed-bencher/)에서 다룬 "벤치마크를 CI에 붙인다"는 개념과, [Tr.01 Google Benchmark 실전](/post/profiling-analysis/google-benchmark-practical/)에서 다룬 벤치마크 코드 작성법을 전제로 합니다. 마이크로벤치마크를 작성할 줄 알고, CI가 PR마다 파이프라인을 실행한다는 것만 알면 충분합니다.
