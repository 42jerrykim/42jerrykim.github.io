...
description: "백준 10167 금광 문제는 2차원 평면에 흩어져 있는 금광들 중 특정 직사각형을 골라 그 내부 금광들의 이익의 합이 최대가 되도록 하는 방법을 구하는 알고리즘 문제입니다. 좌표 압축, 스위핑, 세그먼트 트리, 최대 부분합 알고리즘을 결합한 최적화를 요구합니다."
categories: 
- Algorithm
- Sweeping
- Segment-Tree
