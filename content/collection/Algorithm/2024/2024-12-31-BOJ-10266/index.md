...
description: "백준 10266번 시계 사진들 문제는 주어진 시계 바늘 각도를 정렬하여 인접한 각도 차이의 배열을 만든 뒤, KMP 등 문자열 매칭 알고리즘을 통해 두 시계의 상태가 회전 이동으로 같아질 수 있는지 빠르고 정확하게 판별하는 알고리즘 문제입니다. 대규모 데이터와 효율을 모두 고려합니다."
categories: 
- Algorithm
- String
- Pattern-Matching
