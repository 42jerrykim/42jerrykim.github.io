...
description: "이 글에서는 그래프의 가중치와 시간 조건이 있는 경로의 개수를 구하는 백준 1533번 문제를 다룹니다. 인접 행렬 및 블록 행렬, 행렬 거듭제곱을 활용해 효율적으로 정확히 T분만큼 이동하는 경로 수를 구하는 방법과 핵심 아이디어, 코드 구현까지 상세히 설명합니다."
categories: 
- Algorithm
- GraphTheory
