...
description: "백준 11280번 2-SAT - 3 문제는 2-CNF 논리식의 모든 절을 만족할 수 있는 변수 할당이 존재하는지 판단하는 문제입니다. 그래프와 SCC 알고리즘을 활용하여 각 변수와 부정 변수의 연결 관계를 분석하고, 불가능 조건을 효율적으로 판정하는 과정과 논리-그래프 변환, SCC 판별의 알고리즘적 원리를 상세히 다룹니다."
categories: 
- Algorithm
- Graph
- SCC
