...
블록 I/O 경로 자체의 큐잉·스케줄러 선택·파일시스템별 차이 같은 심화 주제는 이 트랙의 범위를 넘어서며, I/O 트랙(Tr.11)에서 이어받는다. 이 장에서는 "cgroups v2가 I/O 대역폭과 지연을 어떤 손잡이로 제어하는가"까지만 다룬다.
