...
이 글의 목표는 단순합니다. <strong>분석(What)</strong>과 <strong>설계(How)</strong>를 구분하고, 요구사항에서 설계로 넘어갈 때 무엇을 “보존”해야 하는지(추적가능성/일관성/검증가능성)를 실무적으로 정리합니다.
...
- 다음: [03. 객체지향 4대 원칙의 심층 분석](../oop-four-principles-deep-analysis/)
