...
draft: false
image: wordcloud.png
title: "[Regression 10] Performance Budget 운영"
...
**전제 지식**: 이 장은 [PR 성능 게이트 설계](/post/regression-prevention/pr-performance-gate-design/)에서 다룬 "PR 단위로 성능을 비교해 pass/fail을 내리는 게이트"가 이미 존재한다고 가정합니다. 또한 예산 숫자 자체를 어떻게 산정하는지(SLO에서 컴포넌트별 예산을 배분하는 방법론)는 [Tr.09 성능 예산 수립](/post/design-decisions/performance-budgeting-methodology/)에서 다루므로 이 장에서는 반복하지 않습니다.
