...
aliases: ["/algorithm/algorithm/", "/2024-08-26-algorithm/"]
date: "2024-08-27T00:00:00Z"
header:
...
|![](/assets/images/2024/2024-08-27-algorithm.png)|
|:---:|
||
...
## 2. 알고리즘의 주제별 분류
   ...
   ### 2.2 탐색 알고리즘 (Searching Algorithm)
   - 탐색 문제 정의
   - 주요 종류
   ...
   ### 2.3 스트링 매칭 알고리즘 (String Matching Algorithm)
   - 정의 및 필요성
   - 주요 알고리즘
     - KMP 알고리즘
     - 라빈-카프 알고리즘

   ### 2.4 정렬 알고리즘 (Sorting Algorithm)
   - 정렬 문제 정의
   - 주요 종류
   ...
   ### 2.6 해시 알고리즘 (Hash Algorithm)
   - 해시 함수의 정의
   - 해시 테이블의 구조와 활용

   ### 2.7 최적화 알고리즘 (Optimizing Algorithm)
   - 최적화 문제의 정의
   - 주요 기법
     - 선형 프로그래밍
     - 유전자 알고리즘
...
## 3. 알고리즘에 확률의 개입 여부에 따른 분류
   ### 3.1 결정 알고리즘 (Deterministic Algorithm)
   ### 3.2 확률 알고리즘 (Probabilistic Algorithm)
   - 몬테칼로 알고리즘
   - 라스베가스 알고리즘
