---
title: "[Cycling] Cannondale SmartSense Gen 2: 자전거 안전 기술의 진화"
description: "Cannondale SmartSense Gen 2는 800루멘 헤드라이트, 140m 후방 레이더, 50Wh 통합 배터리로 사이클링 안전을 혁신한다. Gen 1 대비 주요 개선점과 실용 사용 가이드를 분석한다."
date: 2026-02-20
lastmod: 2026-02-20
categories:
  - Cycling
...
```mermaid
graph TD
    Battery["SmartSense Gen 2</br>배터리 (50Wh)"]
    Battery --> Headlight["헤드라이트</br>800루멘"]
    Battery --> RadarTail["후방 레이더 +</br>테일라이트 (140m)"]
    Battery --> AXS["SRAM AXS</br>전자 변속기"]
    RadarTail -->|"ANT+ 브로드캐스트"| HeadUnit["사이클링 컴퓨터</br>(Garmin/Wahoo/Hammerhead)"]
    RadarTail -->|"Bluetooth"| App["Cannondale App"]
    App --> Headlight
    App --> RadarTail
    App --> Battery
```
