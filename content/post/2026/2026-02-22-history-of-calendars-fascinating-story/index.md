---
title: "[History] 달력의 재미난 역사: 인류가 시간을 길들인 1만 년"
description: "1만 년 전 스코틀랜드 워런 필드 달력부터 수메르·로마·카이사르 율리우스력, 오마르 카이얌의 소수점 6자리 정밀도, 마야 52년 주기, 1582년 사라진 10일까지. 매일 쓰는 달력에 숨은 인류의 천문·권력·종교 이야기를 풀어썼고, 참고 문헌을 바탕으로 핵심 사건과 수치를 정리했다."
date: 2026-02-22
lastmod: 2026-03-17
categories:
  - History
...
**이 포스트에서 다루는 내용**
- 선사시대 동굴 벽화·구덩이 달력부터 현대 그레고리력까지의 흐름
- 수메르·로마·페르시아·마야·아프리카 등 문명별 달력 체계
- 1월부터 12월까지 달 이름의 유래와 로마 달력의 유산
- 참고 문헌을 활용한 핵심 사건·수치 정리

**추천 대상**: 역사·천문·문화에 관심 있는 독자, 달력과 시간 체계의 기원을 알고 싶은 사람.
...
Mermaid 규칙에 따라 타임라인 제목·이벤트 라벨에 괄호·콜론 등이 포함될 수 있는 부분은 큰따옴표로 감쌌다. 섹션 ID는 예약어를 피해 영문으로 두었다.
...
- **Ianuarius**: 문과 시작의 신 <strong>야누스(Janus)</strong>의 이름. 두 얼굴을 가진 야누스는 한 얼굴로 지나간 해를, 다른 얼굴로 새로 올 해를 바라본다. 연말에 붙인 달이었지만, 이름만큼은 "시작"을 상징했다.
- **Februarius**: 로마의 정화 의식 축제 <strong>페브루아(Februa)</strong>에서 유래. 새해를 맞이하기 전 몸과 마음을 씻어내는 "대청소의 달"이었다.
...
- <strong>중국 송시력(授時曆)</strong>은 13–14세기에 구면삼각법을 사용해 열대년의 길이를 계산했는데, 그 결과가 365.2425일로 그레고리력과 동일하다. 유럽보다 300년 앞서 같은 결론에 도달한 셈이다.
...
**한 줄 요약**: 달력은 인류가 천문을 관측하고, 권력과 종교를 반영하며, 농사와 생활을 맞추기 위해 쌓아온 1만 년의 기록이며, 완벽한 한 가지 답은 없고 여러 문명이 각자 방식을 남겨 오늘까지 이어지고 있다.

**참고 문헌**

1. Wikipedia. [History of calendars](https://en.wikipedia.org/wiki/History_of_calendars). (접근 가능 확인됨)
2. Wikipedia. [Julian calendar](https://en.wikipedia.org/wiki/Julian_calendar). (율리우스력·혼돈의 해 등)
3. Wikipedia. [Gregorian calendar](https://en.wikipedia.org/wiki/Gregorian_calendar). (1582년 개혁·10일 삭제 등)
