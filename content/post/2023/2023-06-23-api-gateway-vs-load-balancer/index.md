...
API Gateway는 <strong>요청의 균형(라우팅·정책)</strong>을, Load Balancer는 **서버·트래픽의 균형**을 담당한다고 보면 됩니다.
...
- **Load Balancer**: <strong>여러 서버(인스턴스)</strong>에 트래픽을 나누어 부하와 가용성을 관리합니다. “어느 서버가 여유 있는가”에 초점을 둡니다.
