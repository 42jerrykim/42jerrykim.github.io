...
본 문서는 <strong>ChatGPT 공식 학생용 유스케이스(100 chats)</strong>를 학업(Study)·커리어(Career)·일상(Life) 카테고리로 재구성한 실사용 가이드다. 각 항목마다 제목, 프롬프트 문장, ChatGPT·Claude 바로 실행 링크를 제공하며, 대괄호 플레이스홀더를 자신의 상황에 맞게 채워 넣어 즉시 활용할 수 있다. 원문 형식과 출처는 글 말단의 [참고 문헌](#참고-문헌)을 참고하면 된다.
...
### Decode a tough passage of text
...
### Get recipes, then customize them
Help me make [dish].
...
### Get project instructions from a photo
...
### Translate signs into your language
