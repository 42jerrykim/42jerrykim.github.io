...
| **q** | 9, 8 | <strong>꼬리는 선(stroke)</strong>으로만 그리며, 9처럼 동그란 고리로 만들지 않는다. 8과도 구분되게 한다. |
...
| 문자 | 혼동 가능 | 필기 요령 |
|------|-----------|-----------|
| **I** | 소문자 l, 숫자 1 | <strong>위아래에 가로선(bar)</strong>을 그어 일관되게 쓴다. |
| **O** | 숫자 0 | **안쪽에 작은 곡선·루프**를 넣어 0과 구분한다. |
| **G** | C, 6 | <strong>오른쪽 안쪽에 꺾임(브라켓)</strong>을 분명히 넣어 C·6과 구분한다. |
...
- **Φ (phi), Ψ (psi)**: 대문자 I처럼 <strong>위아래에 가로선(bar)</strong>을 그어 구분한다.
