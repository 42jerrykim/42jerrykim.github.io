---
title: "[Tablet] CHUWI Hi10 Max 2-in-1 태블릿 리뷰 - 생산성과 휴대성"
...
```mermaid
flowchart LR
  subgraph useCases["활용 모드"]
    TabletMode["태블릿 모드</br>터치와 스타일러스"]
    LaptopMode["노트북 모드</br>키보드 부착"]
    NoteMode["필기 모드</br>스타일러스"]
  end
  Device["Hi10 Max"]
  Device -->|"단독 사용"| TabletMode
  Device -->|"키보드 연결"| LaptopMode
  Device -->|"펜 사용"| NoteMode
```
