...
- **공통**: `.cursor/skills/blog-post-writing/SKILL.md` 및 `reference.md` — 제목 형식·카테고리 접두어, 날짜/lastmod, 컬렉션 내부 링크
