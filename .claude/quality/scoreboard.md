...
| content/collection/design-patterns/02-pattern-analysis-framework/index.md | 96.1 | 2026-07-19 | 3(2차 라운드, 총 6회) | 통과 | 없음(경미: 문단 비율 줄기준 7.4%로 40% 앵커 미달이지만 통과 임계엔 영향 없음, JS require/import 혼용 예시 표기 권장) |
