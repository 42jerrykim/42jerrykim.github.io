...
### Tier 2 — 중간 갭 (3~6점, 1~2개 지점 집중 수정) — 00장 제외 ✅ 완료 (2026-07-20)

| 챕터 | 점수 | 갭 | 핵심 결함 | 조치 | 결과 |
|---|---:|---:|---|---|---|
| **00장** (개요/커리큘럼) | 86.2 | 3.8 | 리스트-only 절 다수, "핵심 개념" 절과 코드 도입부 중복, Java 예제 미정의 타입, Edge-Cases 태그 불일치 | 유형 A+B+C+E 전부 해당 — 00장은 전체 컬렉션의 로드맵이므로 **개정 후 반드시 형제 챕터 링크 재검증**(§6.1 교차 참조 감사) 병행 | 대기(마지막 순서, 파급 범위 큼) |
